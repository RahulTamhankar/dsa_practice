...
public class longestPalindromicSubsequence {
    ...
    public static int palindrome(String s1, String s2) {
        int n1 = s1.length();
        int n2 = s2.length();
        ...
        return dp[n1][n2];  // The length of the longest palindromic subsequence
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Longest Palindromic Subsequence length: " + palindrome(s1, s2));
    }
}
